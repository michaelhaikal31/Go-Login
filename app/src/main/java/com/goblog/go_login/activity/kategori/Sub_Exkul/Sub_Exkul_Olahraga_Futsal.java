...
public class Sub_Exkul_Olahraga_Futsal extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_sub__exkul__olahraga__futsal);
        ...
        collapsingToolbar.setTitle("Olahraga Futsal");
