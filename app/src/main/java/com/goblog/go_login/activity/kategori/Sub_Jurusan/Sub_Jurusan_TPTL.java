...
public class Sub_Jurusan_TPTL extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_sub__jurusan__tptl);
        ...
        collapsingToolbar.setTitle("Teknik Pemanfaaan Tenaga Listrik");
